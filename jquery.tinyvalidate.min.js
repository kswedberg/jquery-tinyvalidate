...
k.summary,r=a(f.wrapper).hide();a(f.insertTo=="form"?g[0]:f.insertTo)[f.insertType](r);if(f.lineItems)var s=f.lineItems.wrapper.match(/[^>]+>/g),A=s[1]+s[0],u=f.lineItems.errorElement?f.lineItems.errorElement.match(/[^>]+>/g):["",""]}a.each(o,function(b,c){a("."+c.ruleClass,g).each(function(){var d=a(this),e=d.data("rule")||[];e.push(o[b]);var h;var v=this.nodeName;if(/(input|textarea|select)/i.test(v))h="inputs";else if(/(div|fieldset|p)/i.test(v))h="containers";h=h||"inputs";d.data("rule",e).data("ruleName",
b).data("elementType",h);i=i.add(d);j&&d.data("insertion",p[h][j.insertType])})});if(j){j.errorElement&&i.bind("addNotice",function(b,c){var d=a(this),e=a.isFunction(d.data("rule")[c].text)?d.data("rule")[c].text.call(this):d.data("rule")[c].text,h=a(j.errorElement);h.html(e);h[a(this).data("insertion")](this).hide();h[j.errorAnimate.effect](j.errorAnimate.speed);d.bind("removeNotice",function(){h.remove()})});i.bind("toggleErrorClass",function(){var b=a(this),c=b.find(":checkbox, :radio").length?
b:b.parents(j.containerTag+":first");b.data("error")?c.addClass(j.containerErrorClass):c.removeClass(j.containerErrorClass)})}if(f){g.bind("displaySummary",function(b,c){r.hide();if(c){var d=f.preMessage.replace(/\{num\}/g,c);d=z(d,c);d=f.lineItems?d+s[0]+t.join(A)+s[1]+f.postMessage:d+f.postMessage;r.html(d)[f.messageAnimate.effect](f.messageAnimate.speed)}});g.bind("hideSummary",function(){r.hide()});f.lineItems&&g.bind("lineItemBuilder",function(b,c,d){b=a(c);var e=a("<div></div>").html(b.data("elementType")==
"containers"?b.children(":first").html():b.prev().clone().html());e.children().remove();e=e.text().replace(/[\*:\s]+$/,"");d=a.isFunction(d.text)?d.text.call(this):d.text;if(f.lineItems.linkify)e='<a href="#'+(b.data("elementType")=="containers"?b.find("input")[0].id:c.id)+'">'+e+"</a>";t.push(e+" "+u[0]+d+u[1])})}i.bind("validate",function(){var b=a(this).trigger("removeNotice"),c=b.data("rule"),d=c.length;b.removeData("error");for(var e=0;e<d;e++){c[e].elem&&c[e].elem(b);var h=c[e].check=="element"?
b:b.val();if(!c[e].rule(h)&&!b.is(":hidden"))if(!(b.is(".required")&&c[e].ruleClass!="required"&&!b.val())){b.data("error","true").trigger("addNotice",[e]);g.trigger("lineItemBuilder",[this,c[e]]);q++}}b.trigger("toggleErrorClass")});g.bind("submit.tv",function(){q=0;t=[];i.trigger("validate");g.trigger("displaySummary",[q]);if(q)return false;else if(k.submitOverride){g.tinyvalidate("removeErrors");k.submitOverride.call(g[0],k);return false}});if(k.otherEvents){if(typeof k.otherEvents=="string")var w=
k.otherEvents.split(/\s*,\s*/);for(l=w.length-1;l>=0;l--)i.bind(w[l]+".tv",function(b){b.type=="click"&&!/^(?:radio|checkbox)$/i.test(b.target.type)||a(this).trigger("validate")})}})};a.fn.tinyvalidate.defaults={otherEvents:"blur",submitOverride:null};a.fn.tinyvalidate.defaults.inline={insertType:"after",errorElement:'<div class="error-message"></div>',errorAnimate:{effect:"fadeIn",speed:400},containerTag:"div",containerErrorClass:"error"};a.fn.tinyvalidate.defaults.summary={insertTo:"form",insertType:"append",
wrapper:'<div class="error-summary"></div>',preMessage:"Please review the {num} highlighted {field|fields} and try again.<ul>",postMessage:"</ul>",messageAnimate:{effect:"fadeIn",speed:400},lineItems:{wrapper:"<li></li>",errorElement:'<span class="error-message"></span>',linkify:true}};a.extend(p.inputs,{append:"insertAfter",appendTo:"insertAfter",after:"insertAfter",insertAfter:"insertAfter",prepend:"insertBefore",prependTo:"insertBefore",before:"insertBefore",insertBefore:"insertBefore"});a.extend(p.containers,
