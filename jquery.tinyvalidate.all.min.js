...
+a.tinyvalidate.maxnum},text:function(){return"No more than "+this.className.replace(/.*max-(\d+).*/,"$1")+" options may be selected"},check:"element"};a.tinyvalidate.rules.equals={ruleClass:"equals",rule:function(c){var o=false;a(c).parents("form:first").find("[name="+c[0].name+"]").each(function(v){if(v&&this.value!==o)return o=false;o=this.value});return o===false?false:true},text:"These fields must match",check:"element"}})(jQuery);
